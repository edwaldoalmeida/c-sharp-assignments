...
namespace WpfApp100
{
    public class AdultParty : Party
    {
        ...
        public AdultParty(string customerName, string customerCity, int averageAge, int partyDay) : base (customerName, customerCity, averageAge, partyDay)
        {
