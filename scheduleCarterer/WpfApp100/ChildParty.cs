...
namespace WpfApp100
{
    class ChildParty : Party
    {
        ...
        public ChildParty(string customerName, Cities customerCity, int averageAge, int partyDay) : base(customerName, customerCity, averageAge, partyDay)
        {
