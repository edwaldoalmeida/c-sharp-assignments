...
namespace WpfApp100
{
    class SeniorParty : Party
    {
        ...
        public SeniorParty(string customerName, Cities customerCity, int averageAge, int partyDay) : base(customerName, customerCity, averageAge, partyDay)
        {
