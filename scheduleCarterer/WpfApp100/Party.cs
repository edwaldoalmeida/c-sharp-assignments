...
namespace WpfApp100
{
    abstract class Party : IParty
    {
        ...
        private Cities customerCity = Cities.Kitchener;
        ...
        public Party(string customerName, Cities customerCity, int averageAge, int partyDay)
        {
            CustomerName = customerName;
            CustomerCity = (Cities)customerCity;
        ...
        public Cities CustomerCity { get => customerCity; set => customerCity = value; }
